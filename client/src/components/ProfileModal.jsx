        ...
        <div className="max-w-2xl sm:py-6 mx-auto">
          ...
          <div className="">
           ...
           <div className="flex justify-end space-x-3 pt-6">
            <button onClick={()=>setShowEditProfile(false)} type='button' className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer">Cancel</button>
